...
def login():
    ...
    try:
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;91m[!] \x1b[1;93mAccount is on Checkpoint'
            os.system('rm -rf login.txt')
            time.sleep(1)
            keluar()
        else:
            print '\n\x1b[1;91m[!] Login Successful'
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
